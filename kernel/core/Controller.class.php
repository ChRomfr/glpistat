...
class Controller{
	...
	public function load_model($model, $type = null){
       ...
       switch ($type){
            ...
            default:
                if( is_file(ROOT_PATH . 'model' . DS . $model .'Model.php') )
				    require_once ROOT_PATH . 'model' . DS . $model .'Model.php';
	...
	public function load_controller($controller, $type = null){
        ...
        switch ($type){
            ...
            case 'admin':
                require_once ROOT_PATH . 'adm' . DS . 'controller' . DS . $controller .'.php';
                break;
            ...
            default:
				if( is_file(ROOT_PATH . 'app' . DS . 'controller' . DS . $controller .'.php') )
					require_once ROOT_PATH . 'app' . DS . 'controller' . DS . $controller .'.php';
				elseif( is_file(ROOT_PATH . 'adm' . DS . 'controller' . DS . $controller .'.php' ) )
					require_once ROOT_PATH . 'adm' . DS . 'controller' . DS . $controller .'.php';
        }
